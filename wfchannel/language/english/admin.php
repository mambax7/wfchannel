...
define('_MA_EWFC_PAGE_UPLOADDIR_DSC','Please enter the path of the import folder. This foler must be within the XOOPS document root<br /><br />Example: uploads/import');
