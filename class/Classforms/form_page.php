...
$form = new Xoopsforms\XoopsThemeTabForm((!$this->isNew()) ? \sprintf(\_AM_WFP_MODIFY, $this->getVar('wfc_title')) : \_AM_WFP_CREATE, 'page_form', 'main.php'); //mb
 ...
 * Page Image
 */
$page_image = new Xoopsforms\XoopsFormSelectImage(\_AM_EWFC_PAGE_LOGO, 'wfc_image', $this->getVar('wfc_image', 'e'), 'xoops_image', 0, $size = 5);
