...
{
    $form = _MB_WFCHANNEL_DISP . "&nbsp;";
    $form .= "<input type='hidden' name='options[]' value='";
    $form .= "wfc_publish'";
    $form .= " />";
    $form .= "<input type='text' name='options[]' value='" . $options[1] . "' />";
    $form .= "&nbsp;<br />" . _MB_WFCHANNEL_CHARS . "&nbsp;<input type='text' name='options[]' value='" . $options[2] . "' />";
    $form .= "&nbsp;<br />" . _MB_WFCHANNEL_DATEFORMAT . "&nbsp;<input type='text' name='options[]' value='" . $options[3] . "' />";
    $options[4] = !isset($options[4]) ? 'wfchannel' : $options[4];
    $form .= "&nbsp;<br />" . _MB_WFCHANNEL_MODULE . "&nbsp;<input type='text' name='options[]' value='" . $options[4] . "' />";
